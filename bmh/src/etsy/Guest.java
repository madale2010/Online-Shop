...
public class Guest {
	...
	*/
	public static void claimGuest(String guestId){EtsyService.postService("/guests/"+guestId+"/claim");}
	/**
	...
	*/
	public static void mergeGuest(String guestId){EtsyService.postService("/guests/"+guestId+"/merge");}
