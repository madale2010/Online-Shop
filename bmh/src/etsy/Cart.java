...
public class Cart extends EtsyService {
	...
	public static void addToCart() {
		EtsyService.postService("/users/__SELF__/carts");
	}

	public static void updateCartListingQuantity() {
		EtsyService.putService("/users/__SELF__/carts");
	}
	...
	public static void updateCart(String cartid) {
		EtsyService.putService("/users/__SELF__/carts/"+cartid);
	}
	...
	public static void addAndSelectShippingForApplePay(String cartid) {
		EtsyService.postService("/users/__SELF__/carts/"+cartid+"/add_and_select_shipping_for_apple");
	}
	...
	public static void createSingleListingCart(){
		EtsyService.postService("/users/__SELF__/carts/single_listing");
	}
}
